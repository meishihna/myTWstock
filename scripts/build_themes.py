...
THEME_DEFINITIONS = {
    ...
    # === 新增 5 題材(2026-06):BBU / AI 眼鏡 / 重電電網 / 運動休閒 / 電子紙 ===
    "bbu": {
        "name": "BBU 伺服器備援電池",
        "desc": "AI 伺服器機櫃級備援電池模組(Battery Backup Unit),斷電瞬間供電供資料寫入,隨 NVIDIA GB200/GB300 NVL72 列為標配而需求爆發,台廠主導電池 Pack 與 BMS 環節。",
        "related": ["AI 伺服器", "資料中心", "電動車"],
        "category": "AI 伺服器",
        "cagr": "50%+",
        "market_size": "全球資料中心 BBU 約 US$0.95B(2025)→US$2.1B(2032)",
        "indicators": [
            {"label": "主要產品", "value": "機櫃級備援電池模組"},
            {"label": "需求動能", "value": "GB200/GB300 NVL72 標配"},
            {"label": "技術核心", "value": "高倍率電芯 / BMS"},
            {"label": "代表廠商", "value": "AES-KY / 順達 / 新盛力"},
        ],
        "members": {
            "upstream": {
                "連接器與線束": ["3003", "3665", "3023"],
                "電路保護元件": ["6224"],
            },
            "midstream": {
                "電池模組與 BMS": ["6781", "3211", "4931", "3323", "6121", "3625"],
            },
            "downstream": {
                "電源整合 (Power Shelf)": ["2308", "2301"],
                "AI 伺服器整機 ODM": ["2317", "2382", "3231", "6669", "2376"],
            },
        },
    },
    "ai-glasses": {
        "name": "AI 智慧眼鏡",
        "desc": "AI／AR 智慧眼鏡 2025–26 年放量,台廠橫跨光學鏡片、波導、microLED／microOLED 微顯示、SoC 與感測、電源與系統組裝。",
        "related": ["Apple", "Micro LED", "VCSEL", "光學鏡頭"],
        "category": "消費終端",
        "cagr": "高成長",
        "market_size": "AR 眼鏡 2030 出貨上看 3,210 萬台",
        "indicators": [
            {"label": "顯示技術", "value": "Micro LED / Micro OLED"},
            {"label": "光學方案", "value": "Pancake / 光波導"},
            {"label": "核心客戶", "value": "Meta / Apple / Google"},
            {"label": "台廠角色", "value": "光學 / 顯示 / 組裝"},
        ],
        "members": {
            "upstream": {
                "Micro LED 晶粒/微顯示": ["6854", "3714", "2409"],
                "主控/連網 SoC 與感測": ["2454", "6526", "3227"],
                "顯示驅動 IC / 電源": ["3527", "3034", "8016", "6415"],
            },
            "midstream": {
                "光學鏡片/鏡頭": ["3008", "3406", "3019", "4976", "3362"],
                "光學模組/波導整合": ["3504", "6456", "3673"],
                "軟板/電池模組": ["4958", "6121"],
            },
            "downstream": {
                "系統組裝/品牌代工": ["2317", "2382"],
    ...
    "power-grid": {
        "name": "重電與智慧電網",
        "desc": "AI 資料中心用電激增、美國老舊電網汰換與台電強韌電網計畫共同引爆變壓器、開關設備(GIS)、配電盤與高壓電纜需求,全球變壓器交期拉長至 18–30 個月。",
        "related": ["儲能", "離岸風電", "電動車", "AI 伺服器"],
        "category": "傳產工業",
        "cagr": "高個位數~雙位數",
        "market_size": "台電強韌電網計畫十年 5,645 億元",
        "indicators": [
            {"label": "需求動能", "value": "AI 用電 / 電網汰換"},
            {"label": "主要產品", "value": "變壓器 / GIS / 高壓電纜"},
            {"label": "產業趨勢", "value": "變壓器缺貨,交期 18–30 月"},
            {"label": "代表廠商", "value": "華城 / 中興電 / 士電"},
        ],
        "members": {
            "upstream": {
                "矽鋼片與導體": ["2002", "1605"],
            ...
            "midstream": {
                "變壓器與重電": ["1519", "1503", "2371", "1504"],
                "開關與配電 (GIS/配電盤)": ["1513", "1514"],
                "高壓電力電纜": ["1608", "1618", "1609", "1612", "1615"],
            },
            "downstream": {
                "AI 電力與電源系統": ["2308", "2301", "6282"],
                "儲能與智慧電力統包": ["3027", "6873", "9933"],
            },
        },
    },
    "sport-textile": {
        "name": "運動休閒與機能性紡織",
        "desc": "Athleisure 結構性成長帶動機能布、針織染整與製鞋代工,台廠垂直整合並以越南/印尼產能供應 Nike、adidas、lululemon 等品牌。",
        "related": [],
        "category": "民生消費",
        "cagr": "高個位數",
        "market_size": "全球運動服飾市場年逾 US$400B",
        "indicators": [
            {"label": "主要產品", "value": "機能布 / 製鞋代工"},
            {"label": "核心客戶", "value": "Nike / adidas / lululemon"},
            {"label": "產業趨勢", "value": "去庫存回補 / 東南亞產能"},
            {"label": "台廠角色", "value": "垂直整合一條龍代工"},
        ],
        "members": {
            "upstream": {
                "化纖紗線(聚酯/尼龍/加工絲)": ["1444", "1455", "1409", "1452"],
            },
            "midstream": {
                "機能布·針織染整": ["1476", "1477", "1460", "1464", "1467"],
                "製鞋代工 (OEM/ODM)": ["9910", "9904", "9802", "6768"],
                "鞋材輔料·機能布料": ["9938", "1307", "4426", "4438"],
            },
        },
    },
    "e-paper": {
        "name": "電子紙 E-Ink",
        "desc": "電泳顯示(EPD)技術,低功耗護眼,應用從電子書擴展至電子貨架標籤(ESL)與大尺寸看板,元太為全球材料與模組壟斷龍頭。",
        "related": ["Micro LED", "物聯網", "面板"],
        "category": "光學顯示",
        "cagr": "雙位數",
        "market_size": "低碳顯示長線潛在市場上看 US$90B",
        "indicators": [
            {"label": "龍頭地位", "value": "元太 EPD 市佔 >90%"},
            {"label": "主要應用", "value": "ESL / 電子書 / 看板"},
            {"label": "產業趨勢", "value": "黑白→四色 · 大尺寸"},
            {"label": "護城河", "value": "電子墨水專利壟斷"},
        ],
        "members": {
            "upstream": {
                "電子紙驅動 IC": ["3141", "4961", "6927"],
            },
            "midstream": {
                "電子紙材料·模組": ["8069"],
                "電子書·電子紙 ODM": ["6143"],
    ...
    # === 新增 5 題材(2026-06, 第二優先):FOPLP / WiFi7 / Edge AI / Micro LED / 特用化學 ===
    "foplp": {
        "name": "FOPLP 扇出型面板級封裝",
        "desc": "以方形玻璃/有機面板取代圓形晶圓的次世代扇出型封裝,提升面積利用率與成本,為 AI/HPC 在 CoWoS 之外的外溢與替代路徑;台廠卡位設備、面板級封裝代工與載具。",
        "related": ["CoWoS", "玻璃基板", "ABF 載板", "先進封測"],
        "category": "先進封測",
        "cagr": "新興高成長",
        "market_size": "全球 FOPLP 約 US$0.4B(2024)→US$2B+(2029)",
        "indicators": [
            {"label": "技術核心", "value": "方形面板扇出封裝"},
            {"label": "主要應用", "value": "PMIC / RF / AI-HPC"},
            {"label": "台廠角色", "value": "設備 / 封裝代工 / 載具"},
            {"label": "產業趨勢", "value": "2026 放量起步"},
        ],
        "members": {
            "upstream": {
                "濕製程/清洗設備": ["3131", "3583", "3167"],
                "壓合/檢測/雷射設備": ["2467", "5443", "3563", "8064"],
                "搬運自動化/載具": ["6438", "2464", "3580", "3680"],
            },
            "midstream": {
                "面板級封裝代工": ["3481", "6239", "3711"],
                "後段封裝設備": ["6187"],
            },
            "downstream": {
                "面板廠轉封裝/客戶應用": ["2409"],
    ...
    "wifi7": {
        "name": "WiFi 7 次世代無線",
        "desc": "Wi-Fi 7 (802.11be) 導入多鏈路同傳 (MLO)、320MHz 頻寬與 6GHz 頻段,帶動路由器/AP、PC/手機與企業網路換機潮,並推升射頻前端用量。",
        "related": ["5G", "低軌衛星"],
        "category": "網路設備",
        "cagr": "雙位數",
        "market_size": "2024–2027 出貨量 CAGR 約 87%",
        "indicators": [
            {"label": "技術核心", "value": "MLO / 320MHz / 6GHz"},
            {"label": "關鍵元件", "value": "Wi-Fi SoC / GaAs PA / 天線"},
            {"label": "主要應用", "value": "路由器 / PC / 企業網路"},
            {"label": "台廠角色", "value": "Wi-Fi SoC + 網通 ODM"},
        ],
        "members": {
            "upstream": {
                "Wi-Fi SoC / 網通晶片": ["2454", "2379"],
                "RF 前端 (PA/FEM) / GaAs": ["4968", "3105", "8086", "2455"],
                "RF 天線": ["3138"],
            },
            "midstream": {
                "路由器 / AP / 閘道器": ["2345", "6285", "5388", "3596", "3704", "3380"],
                "企業 / 消費網通": ["3558", "2332", "4906"],
            },
            "downstream": {
                "PCB / CCL 基板": ["6213"],
            },
    ...
    "edge-ai": {
        "name": "邊緣運算 Edge AI",
        "desc": "在裝置端或網路邊緣(工業電腦、邊緣伺服器、AI Box)執行 AI 推論,以兼顧低延遲、隱私與成本,取代純雲端運算。",
        "related": ["AI 伺服器", "AI PC", "物聯網"],
        "category": "AI 伺服器",
        "cagr": "20%+",
        "market_size": "全球約 US$25B(2025)→US$118B(2033)",
        "indicators": [
            {"label": "技術核心", "value": "邊緣 AI SoC / NPU"},
            {"label": "主要應用", "value": "智造 / 零售 / 車載 / 醫療"},
            {"label": "台廠角色", "value": "IPC 全球市佔逾五成"},
            {"label": "需求動能", "value": "AI 推論下沉至邊緣"},
        ],
        "members": {
            "upstream": {
                "邊緣 AI SoC/NPU": ["2454", "2379"],
                "ASIC 設計服務": ["3443", "3661"],
                "矽智財 IP": ["3035", "6533"],
            },
            "midstream": {
                "IPC 平台大廠": ["2395", "6414", "6166", "6579", "3005"],
                "利基型工業電腦/嵌入式": ["8050", "3022", "3479", "2397", "8234", "3088"],
            },
            "downstream": {
                "智慧零售/POS 整合": ["6206", "8114"],
                "網安/網通邊緣運算": ["6416", "6245"],
            },
        },
    },
    "micro-led": {
        "name": "Micro LED",
        "desc": "微型化自發光顯示技術,每顆 LED 即一畫素,具高亮度、高效率與長壽命;屬自發光顯示(與作為 LCD 背光的 Mini LED 截然不同),主攻 AR 微顯示、車用與大尺寸顯示。",
        "related": ["Mini LED", "OLED", "AI 智慧眼鏡"],
        "category": "光學顯示",
        "cagr": "90%+",
        "indicators": [
            {"label": "技術核心", "value": "自發光微米級 LED"},
            {"label": "關鍵製程", "value": "巨量轉移 / 修補 / 檢測"},
            {"label": "主要應用", "value": "AR / 車用 / 大尺寸顯示"},
            {"label": "台廠角色", "value": "磊晶 / 設備 / 驅動IC / 面板"},
        ],
        "members": {
            "upstream": {
                "磊晶與晶粒": ["3714", "6854", "2426"],
                "巨量轉移與檢測設備": ["8064", "5443", "3455"],
            },
            "midstream": {
                "驅動 IC": ["3527"],
                "LED 封裝": ["2393", "6168"],
    ...
    "specialty-chem": {
        "name": "特用化學 Specialty Chemicals",
        "desc": "半導體、顯示與 PCB 製程所需電子級溶劑、特化品、特殊氣體與先進材料,技術門檻高、認證壁壘深的在地特化供應鏈。",
        "related": ["光阻液", "EUV", "ABF"],
        "category": "半導體製造",
        "cagr": "高個位數",
        "indicators": [
            {"label": "材料類別", "value": "溶劑 / 特氣 / CMP / 高分子"},
            {"label": "主要應用", "value": "晶圓濕製程 / 封裝 / 顯示 / PCB"},
            {"label": "台廠角色", "value": "在地特化 + 材料通路"},
            {"label": "產業趨勢", "value": "材料在地化 / 高認證壁壘"},
        ],
        "members": {
            "upstream": {
                "電子級溶劑": ["1773", "4755"],
                "電子級酸 / 特化前驅體": ["1727", "4722"],
            },
            "midstream": {
                "半導體濕製程 / CMP 化學品": ["5234", "1711", "1713"],
                "電子級特殊氣體": ["4772", "4768"],
                "PCB / 封裝高分子材料": ["1717", "6509"],
                "顯示光學材料": ["6434"],
            },
            "downstream": {
                "材料通路 / 特化代理": ["5434", "3010", "3388"],
                "化學品交付設備": ["4770"],
                "應用端(晶圓廠 / 面板廠)": ["2330", "2409"],
            },
        },
    },

    # === 新增 6 題材(2026-06, 大類補完 + 品牌供應鏈):營建/塑化/鋼鐵/金融 + AMD/高通 ===
    "construction-re": {
        "name": "營建與不動產",
        "desc": "涵蓋建商開發、科技廠房營造、低碳建材與資產活化租賃,受惠都更危老、AI 廠辦興建與房市循環。",
        "related": ["重電與智慧電網"],
        "category": "營建不動產",
        "cagr": "景氣循環",
        "indicators": [
            {"label": "主要業務", "value": "建商 / 營造 / 資產"},
            {"label": "需求動能", "value": "都更危老 / AI 廠辦"},
            {"label": "產業特性", "value": "利率與房市循環"},
            {"label": "代表廠商", "value": "興富發 / 達欣工"},
        ],
        "members": {
            "upstream": {
                "水泥與低碳建材": ["1101", "1102", "2504"],
                "科技廠房營造": ["2597", "2535", "2546", "5515"],
            },
            "midstream": {
                "大型推案建商": ["2542", "5522", "1808", "2501"],
                "績優財務建商": ["2548", "5534", "6177"],
            },
            "downstream": {
                "資產活化多角化": ["2520", "2515"],
                "代銷與房仲": ["2348", "9940"],
    ...
    "petrochem": {
        "name": "塑化 Petrochemicals",
        "desc": "台灣石化/塑膠產業,以台塑四寶為核心,從輕油裂解的乙烯/丙烯/苯延伸至 PE/PP/PVC/ABS/SM/EG 等泛用樹脂;屬景氣循環股,獲利隨油價、中國供需與產品價差起伏。",
        "related": ["特用化學", "電動車"],
        "category": "原物料",
        "cagr": "景氣循環",
        "market_size": "台塑四寶合計年營收逾 1.5 兆台幣",
        "indicators": [
            {"label": "主要產品", "value": "PE / PP / PVC / ABS"},
            {"label": "關鍵變數", "value": "油價 / 產品價差"},
            {"label": "產業特性", "value": "景氣循環 / 垂直整合"},
            {"label": "代表廠商", "value": "台塑四寶"},
        ],
        "members": {
            "upstream": {
                "煉油 / 輕油裂解": ["6505"],
            ...
            "midstream": {
                "PE / PP / EVA 聚烯烴": ["1304", "1308", "1309"],
                "PVC / 可塑劑": ["1305", "1313"],
                "ABS / PTA / 尼龍": ["1326", "1314"],
                "綜合泛用樹脂": ["1301"],
            },
            "downstream": {
                "塑膠加工 / 應用": ["1303", "1321", "1315"],
                "合成橡膠 / 碳黑": ["2103", "2108", "2104"],
            },
        },
    },
    "steel": {
        "name": "鋼鐵 Steel",
        "desc": "中國鋼材出口 2026 年估減近 2,000 萬噸、台灣對中熱軋祭出 16–20% 反傾銷稅,加上基建/資料中心拉貨與不鏽鋼鎳價回升,帶動高爐、電爐鋼筋、不鏽鋼與特殊鋼價差修復。",
        "related": ["重電與智慧電網", "營建與不動產"],
        "category": "原物料",
        "cagr": "景氣循環",
        "market_size": "中國 2026 鋼材外銷估減約 1,900 萬噸",
        "indicators": [
            {"label": "主要產品", "value": "鋼筋 / 熱軋 / 不鏽鋼"},
            {"label": "關鍵變數", "value": "中國減產 / 反傾銷 / 鎳價"},
            {"label": "需求動能", "value": "基建 / 資料中心 / 國防"},
            {"label": "代表廠商", "value": "中鋼 / 東和 / 榮剛"},
        ],
        "members": {
            "upstream": {
                "高爐一貫廠 / 鋼胚": ["2002", "2014"],
            ...
            "midstream": {
                "電爐鋼筋 · 條鋼": ["2006", "2015", "2028", "2038"],
                "不鏽鋼一貫廠": ["9957", "2035", "2025"],
                "特殊鋼 · 合金鋼": ["5009"],
            },
            "downstream": {
                "鍍面鋼 · 鋼板加工": ["2023", "2029"],
                "不鏽鋼管 · 配管通路": ["2034", "2030", "2027"],
                "鋼構 · 扣件 · 線材": ["2013", "2211", "2017", "2012", "2031"],
            },
        },
    },
    "financials": {
        "name": "金融（銀行・壽險・證券）",
        "desc": "涵蓋金控、銀行、壽險與證券期貨的台灣金融業,受惠淨利差、財富管理與資本市場交易量,兼具高股息防禦特性。",
        "related": [],
        "category": "金融航運",
        "cagr": "穩健",
        "market_size": "金控業年稅後淨利逾 5,000 億台幣",
        "indicators": [
            {"label": "主要業務", "value": "銀行 / 壽險 / 證券"},
            {"label": "關鍵變數", "value": "利率利差 / 匯率避險"},
            {"label": "投資特性", "value": "高股息防禦"},
            {"label": "代表業者", "value": "富邦金 / 國泰金 / 中信金"},
        ],
        "members": {
            "upstream": {
                "大型民營金控": ["2881", "2882", "2891", "2884", "2885", "2887"],
                "公股金控": ["2886", "2892", "2880", "5880", "2890"],
                "資本市場型金控": ["2883", "2889"],
            },
            "midstream": {
                "公股銀行": ["2801", "2834"],
    ...
    "AMD": {
        "name": "AMD 供應鏈",
        "desc": "AMD MI300/MI350 AI GPU、EPYC 伺服器 CPU 與 Ryzen PC CPU 的台灣供應鏈,涵蓋晶圓代工、封測、載板、伺服器/顯卡組裝與散熱電源。",
        "related": ["NVIDIA", "AI 伺服器", "CoWoS"],
        "category": "AI 伺服器",
        "cagr": "高成長",
        "market_size": "AMD 為全球第二大 AI 加速器供應商",
        "indicators": [
            {"label": "核心產品", "value": "MI300/MI350 / EPYC / Ryzen"},
            {"label": "台廠角色", "value": "代工封裝 + 伺服器組裝"},
            {"label": "需求動能", "value": "AI 資料中心 GPU 放量"},
            {"label": "關鍵環節", "value": "CoWoS / ABF 載板 / 插槽"},
        ],
        "members": {
            "upstream": {
                "晶圓代工": ["2330"],
                "封測": ["3711", "2449", "6257", "6239"],
                "ABF 載板": ["3037", "8046", "3189", "2368"],
            },
            "midstream": {
                "伺服器 ODM / 組裝": ["3231", "6669", "2356", "2382"],
                "主機板 / 顯卡": ["2376", "3515", "2377", "6150"],
            },
            "downstream": {
                "散熱": ["3324", "3017"],
                "電源 / 連接器": ["2308", "3533"],
    ...
    "高通": {
        "name": "高通 Qualcomm 供應鏈",
        "desc": "高通 Snapdragon 行動 SoC、5G 數據機與射頻前端的台灣供應鏈,涵蓋晶圓代工、封測、砷化鎵射頻、載板、被動元件與手機／PC 組裝。",
        "related": ["Apple", "5G", "AI 智慧眼鏡"],
        "category": "消費終端",
        "cagr": "穩健",
        "market_size": "高通對台採購年逾 3,000 億台幣",
        "indicators": [
            {"label": "核心產品", "value": "Snapdragon SoC / 5G / RF"},
            {"label": "台廠角色", "value": "代工 / 封測 / 載板 / 射頻"},
            {"label": "需求動能", "value": "去中化轉單 / Snapdragon X"},
            {"label": "關鍵環節", "value": "先進製程代工 / SiP 封測"},
        ],
        "members": {
            "upstream": {
                "晶圓代工": ["2330", "2303"],
                "封裝測試": ["3711", "2449", "6239"],
                "砷化鎵射頻": ["3105", "8086", "2455", "4991"],
            },
            "midstream": {
                "IC 載板": ["3037", "3189", "8046"],
                "被動元件": ["2327", "2492"],
                "測試介面": ["6510", "6515"],
            },
            "downstream": {
                "手機／PC 組裝": ["2317", "2324", "3231"],
                "光學鏡頭": ["3008", "3406"],
            },
        },
    },
